...
import controller.staff.OrderDialogCustomerController;
...
public class OrderDialogCustomer extends JDialog {
	...
	public OrderDialogCustomer(StaffFrameView staffFrameView, Orders order) {
	...
	public void setEvent() {
		OrderDialogCustomerController orderDialogCustomerController = new OrderDialogCustomerController(this);
		btnBack.addActionListener(orderDialogCustomerController);
		btnCancel.addActionListener(orderDialogCustomerController);
	}
	...
	private void initComponent() {
		...
		btnCancel = new JButton("Cancel", new ImageIcon(getClass().getResource("/icon/Button-Close-icon16.png")));
