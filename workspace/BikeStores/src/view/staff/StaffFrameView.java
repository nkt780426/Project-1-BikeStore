...
import controller.staff.StaffFrameController;

@SuppressWarnings("serial")
public class StaffFrameView extends JFrame {

	private ShopPanel shopPanel = new ShopPanel(this);
	private TransportPanel transportPannel = new TransportPanel(this);
	...
	private void initComponent() {
		...
		btnTransport.setIcon(new ImageIcon(getClass().getResource("/icon/truck-icon72.png")));
		...
		panelCenter.add(transportPannel, "2");
		panelCenter.add(personalPanel, "3");
		panelCenter.add(historyPanel, "4");
		add(panelCenter, BorderLayout.CENTER);

		// EvenListener
		StaffFrameController staffFrameController = new StaffFrameController(this);
		btnShop.addActionListener(staffFrameController);
		mnuiShop.addActionListener(staffFrameController);

		btnTransport.addActionListener(staffFrameController);
		mnuiTransport.addActionListener(staffFrameController);

		btnPersonal.addActionListener(staffFrameController);
		mnuiPersonal.addActionListener(staffFrameController);

		btnHistory.addActionListener(staffFrameController);
		mnuiHistory.addActionListener(staffFrameController);

		btnSignOut.addActionListener(staffFrameController);
		mnuiSignOut.addActionListener(staffFrameController);

		mnucbToolBar.addItemListener(staffFrameController);

		mnuiAboutUs.addActionListener(staffFrameController);
	}
	...
	public TransportPanel getTransportPannel() {
		return transportPannel;
	}
	...
	public JMenuItem getMnuiTransport() {
