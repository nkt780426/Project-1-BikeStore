	...
	public void actionPerformed(ActionEvent e) {
		if (e.getSource() == shopPanel.getBtnSearch()) {
			try {
				...
				e1.printStackTrace();
				JOptionPane.showMessageDialog(shopPanel.getStaffFrameView(), "Incorect input");
			}
		}
		if (e.getSource() == shopPanel.getBtnTransport()) {
			shopPanel.getStaffFrameView().getCardLayout().show(shopPanel.getStaffFrameView().getPanelCenter(),
					"2");
		}
	}
